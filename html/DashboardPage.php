...
<div id="upcp_pro" class="postbox " >
		...
		<div class="inside">
				<ul><li><a href="http://www.etoilewebdesign.com/order-tracking-plugin/"><?php _e("Upgrade to the full version ", "EWD_OTP"); ?></a><?php _e("to take advantage of all the available features of the Order Tracking for Wordpress!", 'EWD_OTP'); ?></li>
				<div class="full-version-form-div">
						<form action="admin.php?page=EWD-OTP-options" method="post">
								<div class="form-field form-required">
										<label for="Catalogue_Name"><?php _e("Product Key", 'EWD_OTP') ?></label>
										<input name="Key" type="text" value="" size="40" />
								</div>							
								<input type="submit" name="Upgrade_To_Full" value="<?php _e('Upgrade', 'EWD_OTP') ?>">
						</form>
				</div>
		</div>
</div>
...
<div id="upcp_pro" class="postbox " >
		...
		<div class="inside">
				<ul>
						<li><?php _e("Thanks for being an early adopter! Anyone who installs before June 30th will always have access to new features, updates and full product support.", 'EWD_OTP'); ?></li>
