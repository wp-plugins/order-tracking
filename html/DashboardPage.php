...
<div id="upcp_pro" class="postbox " >
		...
		<div class="inside">
				<ul>
						<li><?php _e("Thanks for being an early adopter! Anyone who installs before May 31st will always have access to new features, updates and full product support.", 'EWD_OTP'); ?></li>
