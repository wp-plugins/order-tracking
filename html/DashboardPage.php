							...
							<div id="upcp_pro" class="postbox " >
									...
									<h3 class='hndle'><span><?php _e("Thank You!", 'EWD_OTP') ?></span></h3>
							 		<div class="inside">
											...
											<?php } else { ?><ul><li><?php _e("Thanks for upgrading to version 2.0.7!", 'EWD_OTP'); ?><br> <a href='http://wordpress.org/support/view/plugin-reviews/order-tracking'><?php _e("Please rate our plugin", 'EWD_OTP'); ?></a> <?php _e("if you find Order Tracking useful!", 'EWD_OTP');?> </li></ul><?php } ?>
