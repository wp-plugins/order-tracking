...
function Add_Edit_EWD_OTP_Order() {
		...
		$Order_Payment_Price = $_POST['Order_Payment_Price'];
		$Order_Payment_Completed = $_POST['Order_Payment_Completed'];
		$Order_PayPal_Receipt_Number = $_POST['Order_PayPal_Receipt_Number'];
